...
<div id="main">
    ...
    <tr>
    <td class="style20">
        <asp:Label ID="withdrawn" runat="server" Text="Withdraw"></asp:Label>
    </td> 
    <td class="style35">
    ...
    <td class="style36">
        <asp:Button ID="deduct" runat="server" Height="45px" style="margin-left: 11px" 
            Text="Deduct" Width="120px" Font-Bold="True" Font-Size="Medium" onclick="deduct_Click" 
             />
        </td> 
    <td class="style20">
    ...
    <asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Size="Large" 
            Height="53px" style="margin-left: 1336px; margin-top: 0px;" Text="Log Out" 
            Width="136px"  ForeColor="black" onclick="Button1_Click"   />
